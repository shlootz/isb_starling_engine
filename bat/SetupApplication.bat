...
:: Android packaging
set AND_CERT_NAME="StarlingBridge"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingBridge.p12
...
set IOS_PROVISION=cert\StarlingBridge.mobileprovision
...
set APP_ID=air.StarlingBridge

:: Output packages
set DIST_PATH=dist
set DIST_NAME=StarlingBridge
